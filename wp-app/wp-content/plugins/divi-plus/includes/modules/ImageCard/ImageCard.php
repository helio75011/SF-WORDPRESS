...
class DIPL_ImageCard extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( '' !== $icon ) {
            ...
            if ( '' === $image ) {
            	et_pb_responsive_options()->generate_responsive_css( $content_margin_values, '%%order_class%% .dipl_image_card_content_wrapper', 'margin-top', $render_slug, '', 'range' );
            }
			...
			et_pb_responsive_options()->generate_responsive_css( $inner_content_margin_values, '%%order_class%% .dipl_image_card_inner_content_wrapper', 'margin-top', $render_slug, '', 'range' );
